...
public class ArtistDAO {
	...
	public ArrayList<ArtistVO> selectArtist() {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "select * from tbl_artist_201905 order by artist_id desc";
		conn = JdbcUtil.getConnection();
		...
		try {
			...
			while (rs.next()) {
				...
				String printBirth = birth.substring(0, 4) + "년" + birth.substring(4, 6) + "월" + birth.substring(6, 8)
						+ "일";
