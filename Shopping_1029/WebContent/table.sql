...
select a.custno, a.custname, a.grade, sum(b.price) sum_price from MEMBER_TBL_02 a, MONEY_TBL_02 b where a.custno = b.custno group by a.custno, a.custname, a.grade order by sum_price desc;
