...
<section>
	<h1> 오디션 등록 </h1>
	<form action="<%= request.getContextPath() %>/artist/artistInsert" method="post" name="frm" onsubmit="return checkForm()" onreset="return resetForm()">
		<table>
			<tr>
				<td>참가번호</td>
			...
			<tr>
				<td>성별(남성:M, 여성:F)</td>
				<td><input type="gender" name="gender">남</td>
				<td><input type="gender" name="gender">여</td>
			</tr>
			<tr>
